        ...
        <Box fill="vertical" overflow="auto" align="center" flex="grow">
          ...
          <Box className="box_Content" fill="horizontal" width={{ "max": "1250px" }}>
            <Tabs justify="center" flex>
              ...
              <Tab title="New" icon={<Gamepad />} >
                <Newtab rover={this.state.rover} isConnected={this.state.isConnected} roverState={this.state.roverState} roverController={this.state.roverController} />
              </Tabs>
          </Box>
        </Box>
      </Grommet>
