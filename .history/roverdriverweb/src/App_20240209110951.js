          ...
          <Box className="box_Content" fill="horizontal" width={{ "max": "1250px" }}>
            <Tabs justify="center" flex>
              ...
              <Tab title="NewTab" icon={<Info />}>
                  <Box justify="center" gap="small" alignContent="center" margin={{ "top": "small", "bottom": "small", "left": "small", "right": "medium" }} className="tabContents" animation={{ "type": "fadeIn", "size": "small" }} direction="row" align="stretch" fill hoverIndicator={false}>
