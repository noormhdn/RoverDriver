    ...
    render() {
        ...
        return <Box justify="center" pad={{ "top": "none", "bottom": "small", "left": "small", "right": "small" }} className="tabContents" animation={{ "type": "fadeIn", "size": "small" }} direction="row" align="stretch" fill hoverIndicator={false}>
            <StyledCard title="System" >
                ...
                <StateBox icon={<Time size="medium" />} name="On time" value={!this.state.roverState.ontime && "-"}{this.state.roverState.ontime && <Clock type="digital" time={this.state.roverState.ontime} />}
                </StateBox>
            </StyledCard>
